...
SibApiV3Sdk - JavaScript client for sib-api-v3-sdk
...
*SibApiV3Sdk.CRMApi* | [**crmNotesGet**](docs/CRMApi.md#crmNotesGet) | **GET** /crm/notes | Get all notes
...
*SibApiV3Sdk.CRMApi* | [**crmTasksGet**](docs/CRMApi.md#crmTasksGet) | **GET** /crm/tasks | Get all tasks
