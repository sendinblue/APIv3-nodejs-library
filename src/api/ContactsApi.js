...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.PakatApiV3Sdk.ContactsApi = factory(root.PakatApiV3Sdk.ApiClient, root.PakatApiV3Sdk.AddContactToList, root.PakatApiV3Sdk.CreateAttribute, root.PakatApiV3Sdk.CreateContact, root.PakatApiV3Sdk.CreateDoiContact, root.PakatApiV3Sdk.CreateList, root.PakatApiV3Sdk.CreateModel, root.PakatApiV3Sdk.CreateUpdateContactModel, root.PakatApiV3Sdk.CreateUpdateFolder, root.PakatApiV3Sdk.CreatedProcessId, root.PakatApiV3Sdk.ErrorModel, root.PakatApiV3Sdk.GetAttributes, root.PakatApiV3Sdk.GetContactCampaignStats, root.PakatApiV3Sdk.GetContacts, root.PakatApiV3Sdk.GetExtendedContactDetails, root.PakatApiV3Sdk.GetExtendedList, root.PakatApiV3Sdk.GetFolder, root.PakatApiV3Sdk.GetFolderLists, root.PakatApiV3Sdk.GetFolders, root.PakatApiV3Sdk.GetLists, root.PakatApiV3Sdk.PostContactInfo, root.PakatApiV3Sdk.RemoveContactFromList, root.PakatApiV3Sdk.RequestContactExport, root.PakatApiV3Sdk.RequestContactImport, root.PakatApiV3Sdk.UpdateAttribute, root.PakatApiV3Sdk.UpdateContact, root.PakatApiV3Sdk.UpdateList);
  }
