  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('Version A')) {
        obj['Version A'] = ApiClient.convertToType(data['Version A'], 'String');
      }
      if (data.hasOwnProperty('Version B')) {
        obj['Version B'] = ApiClient.convertToType(data['Version B'], 'String');
      }
    }
    return obj;
  }
