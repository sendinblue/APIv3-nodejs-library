...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendinBlueApi.ContactEmails = factory(root.SendinBlueApi.ApiClient);
  }
   ...
   * @module model/ContactEmails
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ContactEmails</code>.
   * @alias module:model/ContactEmails
   * @class
   */
   ...
   * @param {module:model/ContactEmails} obj Optional instance to populate.
   * @return {module:model/ContactEmails} The populated <code>ContactEmails</code> instance.
   */
