...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendinBlueApi.CreateSmsCampaign1 = factory(root.SendinBlueApi.ApiClient, root.SendinBlueApi.SmsCampaignsRecipients);
  }
  ...
  /**
   * The CreateSmsCampaign1 model module.
   * @module model/CreateSmsCampaign1
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>CreateSmsCampaign1</code>.
   * @alias module:model/CreateSmsCampaign1
   * @class
  ...
  /**
   * Constructs a <code>CreateSmsCampaign1</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateSmsCampaign1} obj Optional instance to populate.
   * @return {module:model/CreateSmsCampaign1} The populated <code>CreateSmsCampaign1</code> instance.
   */
