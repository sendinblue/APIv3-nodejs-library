...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendinBlueApi.EmailCampaign = factory(root.SendinBlueApi.ApiClient, root.SendinBlueApi.EmailCampaignscampaignIdRecipients, root.SendinBlueApi.EmailCampaignscampaignIdSender);
  }
   ...
   * @module model/EmailCampaign
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>EmailCampaign</code>.
   * @alias module:model/EmailCampaign
   * @class
   */
   ...
   * @param {module:model/EmailCampaign} obj Optional instance to populate.
   * @return {module:model/EmailCampaign} The populated <code>EmailCampaign</code> instance.
   */
