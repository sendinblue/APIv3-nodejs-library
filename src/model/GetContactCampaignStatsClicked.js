...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetContactCampaignStatsLinks'], factory);
   ...
   * @param links {Array.<module:model/GetContactCampaignStatsLinks>} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('links')) {
        obj['links'] = ApiClient.convertToType(data['links'], [GetContactCampaignStatsLinks]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/GetContactCampaignStatsLinks>} links
   */
