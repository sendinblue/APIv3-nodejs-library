...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetContactCampaignStatsUnsubscriptionsAdminUnsubscription', 'model/GetContactCampaignStatsUnsubscriptionsUserUnsubscription'], factory);
   ...
   * @class
   * @param userUnsubscription {Array.<module:model/GetContactCampaignStatsUnsubscriptionsUserUnsubscription>} Contact has unsubscribed via the unsubscription link in the email
   * @param adminUnsubscription {Array.<module:model/GetContactCampaignStatsUnsubscriptionsAdminUnsubscription>} Contact has been unsubscribed from the administrator
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('userUnsubscription')) {
        obj['userUnsubscription'] = ApiClient.convertToType(data['userUnsubscription'], [GetContactCampaignStatsUnsubscriptionsUserUnsubscription]);
      }
      if (data.hasOwnProperty('adminUnsubscription')) {
        obj['adminUnsubscription'] = ApiClient.convertToType(data['adminUnsubscription'], [GetContactCampaignStatsUnsubscriptionsAdminUnsubscription]);
      }
    }
    return obj;
  }
   ...
   * @member {Array.<module:model/GetContactCampaignStatsUnsubscriptionsUserUnsubscription>} userUnsubscription
   */
  exports.prototype['userUnsubscription'] = undefined;
  /**
   * Contact has been unsubscribed from the administrator
   * @member {Array.<module:model/GetContactCampaignStatsUnsubscriptionsAdminUnsubscription>} adminUnsubscription
   */
