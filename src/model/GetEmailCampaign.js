...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendinBlueApi.GetEmailCampaign = factory(root.SendinBlueApi.ApiClient, root.SendinBlueApi.GetExtendedCampaignOverview, root.SendinBlueApi.GetExtendedCampaignOverviewSender);
  }
  ...
  var exports = function(id, name, subject, type, status, scheduledAt, testSent, header, footer, replyTo, toField, htmlContent, shareLink, tag, createdAt, modifiedAt) {
    ...
    GetExtendedCampaignOverview.call(_this, id, name, subject, type, status, scheduledAt, testSent, header, footer, replyTo, toField, htmlContent, shareLink, tag, createdAt, modifiedAt);
  };
