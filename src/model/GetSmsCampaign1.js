...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendinBlueApi.GetSmsCampaign1 = factory(root.SendinBlueApi.ApiClient, root.SendinBlueApi.InlineResponse20021Statistics, root.SendinBlueApi.InlineResponse2008Recipients);
  }
  ...
  /**
   * The GetSmsCampaign1 model module.
   * @module model/GetSmsCampaign1
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>GetSmsCampaign1</code>.
   * @alias module:model/GetSmsCampaign1
   * @class
   * @param id {Number} ID of the SMS Campaign
   * @param name {String} Name of the SMS Campaign
   * @param status {module:model/GetSmsCampaign1.StatusEnum} Status of the SMS Campaign
  ...
  /**
   * Constructs a <code>GetSmsCampaign1</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetSmsCampaign1} obj Optional instance to populate.
   * @return {module:model/GetSmsCampaign1} The populated <code>GetSmsCampaign1</code> instance.
   */
   ...
   * @member {module:model/GetSmsCampaign1.StatusEnum} status
   */
