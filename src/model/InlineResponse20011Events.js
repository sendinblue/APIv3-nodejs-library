...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendinBlueApi.InlineResponse20011Events = factory(root.SendinBlueApi.ApiClient);
  }
  ...
  /**
   * The InlineResponse20011Events model module.
   * @module model/InlineResponse20011Events
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>InlineResponse20011Events</code>.
   * @alias module:model/InlineResponse20011Events
   * @class
   ...
   * @param event {module:model/InlineResponse20011Events.EventEnum} Event which occured
  ...
  /**
   * Constructs a <code>InlineResponse20011Events</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse20011Events} obj Optional instance to populate.
   * @return {module:model/InlineResponse20011Events} The populated <code>InlineResponse20011Events</code> instance.
   */
  ...
  /**
   * Event which occured
   * @member {module:model/InlineResponse20011Events.EventEnum} event
   */
