...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendinBlueApi.InlineResponse20012Templates = factory(root.SendinBlueApi.ApiClient, root.SendinBlueApi.InlineResponse20012Sender);
  }
  ...
  /**
   * The InlineResponse20012Templates model module.
   * @module model/InlineResponse20012Templates
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>InlineResponse20012Templates</code>.
   * @alias module:model/InlineResponse20012Templates
   * @class
  ...
  /**
   * Constructs a <code>InlineResponse20012Templates</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse20012Templates} obj Optional instance to populate.
   * @return {module:model/InlineResponse20012Templates} The populated <code>InlineResponse20012Templates</code> instance.
   */
