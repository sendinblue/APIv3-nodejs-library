...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendinBlueApi.InlineResponse20014Contacts = factory(root.SendinBlueApi.ApiClient);
  }
  ...
  /**
   * The InlineResponse20014Contacts model module.
   * @module model/InlineResponse20014Contacts
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>InlineResponse20014Contacts</code>.
   * @alias module:model/InlineResponse20014Contacts
   * @class
  ...
  /**
   * Constructs a <code>InlineResponse20014Contacts</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse20014Contacts} obj Optional instance to populate.
   * @return {module:model/InlineResponse20014Contacts} The populated <code>InlineResponse20014Contacts</code> instance.
   */
