...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendinBlueApi.InlineResponse20015Opened = factory(root.SendinBlueApi.ApiClient);
  }
  ...
  /**
   * The InlineResponse20015Opened model module.
   * @module model/InlineResponse20015Opened
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>InlineResponse20015Opened</code>.
   * @alias module:model/InlineResponse20015Opened
   * @class
  ...
  /**
   * Constructs a <code>InlineResponse20015Opened</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse20015Opened} obj Optional instance to populate.
   * @return {module:model/InlineResponse20015Opened} The populated <code>InlineResponse20015Opened</code> instance.
   */
