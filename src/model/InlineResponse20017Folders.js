...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendinBlueApi.InlineResponse20017Folders = factory(root.SendinBlueApi.ApiClient);
  }
  ...
  /**
   * The InlineResponse20017Folders model module.
   * @module model/InlineResponse20017Folders
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>InlineResponse20017Folders</code>.
   * @alias module:model/InlineResponse20017Folders
   * @class
  ...
  var exports = function(id, name, totalBlacklisted, totalSubscribers, uniqueSubscribers) {
    ...
    _this['uniqueSubscribers'] = uniqueSubscribers;
  };

  /**
   * Constructs a <code>InlineResponse20017Folders</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse20017Folders} obj Optional instance to populate.
   * @return {module:model/InlineResponse20017Folders} The populated <code>InlineResponse20017Folders</code> instance.
   */
