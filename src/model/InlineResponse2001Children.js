...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendinBlueApi.InlineResponse2001Children = factory(root.SendinBlueApi.ApiClient, root.SendinBlueApi.InlineResponse2001ApiKeys, root.SendinBlueApi.InlineResponse2001Credits, root.SendinBlueApi.InlineResponse2001Ips, root.SendinBlueApi.InlineResponse2001Statistics);
  }
  ...
  /**
   * The InlineResponse2001Children model module.
   * @module model/InlineResponse2001Children
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>InlineResponse2001Children</code>.
   * @alias module:model/InlineResponse2001Children
   * @class
  ...
  /**
   * Constructs a <code>InlineResponse2001Children</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2001Children} obj Optional instance to populate.
   * @return {module:model/InlineResponse2001Children} The populated <code>InlineResponse2001Children</code> instance.
   */
