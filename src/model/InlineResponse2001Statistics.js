...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendinBlueApi.InlineResponse2001Statistics = factory(root.SendinBlueApi.ApiClient);
  }
  ...
  /**
   * The InlineResponse2001Statistics model module.
   * @module model/InlineResponse2001Statistics
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>InlineResponse2001Statistics</code>.
   * Statistics about your child account activity
   * @alias module:model/InlineResponse2001Statistics
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2001Statistics</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2001Statistics} obj Optional instance to populate.
   * @return {module:model/InlineResponse2001Statistics} The populated <code>InlineResponse2001Statistics</code> instance.
   */
