...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendinBlueApi.InlineResponse20021Campaigns = factory(root.SendinBlueApi.ApiClient, root.SendinBlueApi.InlineResponse20021Statistics, root.SendinBlueApi.InlineResponse2008Recipients);
  }
  ...
  /**
   * The InlineResponse20021Campaigns model module.
   * @module model/InlineResponse20021Campaigns
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>InlineResponse20021Campaigns</code>.
   * @alias module:model/InlineResponse20021Campaigns
   * @class
   * @param id {Number} ID of the SMS Campaign
   * @param name {String} Name of the SMS Campaign
   * @param status {module:model/InlineResponse20021Campaigns.StatusEnum} Status of the SMS Campaign
  ...
  /**
   * Constructs a <code>InlineResponse20021Campaigns</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse20021Campaigns} obj Optional instance to populate.
   * @return {module:model/InlineResponse20021Campaigns} The populated <code>InlineResponse20021Campaigns</code> instance.
   */
   ...
   * @member {module:model/InlineResponse20021Campaigns.StatusEnum} status
   */
