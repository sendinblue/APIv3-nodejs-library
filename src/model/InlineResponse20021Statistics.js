...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendinBlueApi.InlineResponse20021Statistics = factory(root.SendinBlueApi.ApiClient);
  }
  ...
  /**
   * The InlineResponse20021Statistics model module.
   * @module model/InlineResponse20021Statistics
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>InlineResponse20021Statistics</code>.
   * @alias module:model/InlineResponse20021Statistics
   * @class
  ...
  /**
   * Constructs a <code>InlineResponse20021Statistics</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse20021Statistics} obj Optional instance to populate.
   * @return {module:model/InlineResponse20021Statistics} The populated <code>InlineResponse20021Statistics</code> instance.
   */
