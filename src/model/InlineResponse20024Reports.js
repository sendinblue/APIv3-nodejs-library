...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendinBlueApi.InlineResponse20024Reports = factory(root.SendinBlueApi.ApiClient);
  }
  ...
  /**
   * The InlineResponse20024Reports model module.
   * @module model/InlineResponse20024Reports
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>InlineResponse20024Reports</code>.
   * @alias module:model/InlineResponse20024Reports
   * @class
  ...
  /**
   * Constructs a <code>InlineResponse20024Reports</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse20024Reports} obj Optional instance to populate.
   * @return {module:model/InlineResponse20024Reports} The populated <code>InlineResponse20024Reports</code> instance.
   */
