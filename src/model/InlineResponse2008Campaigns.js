...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendinBlueApi.InlineResponse2008Campaigns = factory(root.SendinBlueApi.ApiClient, root.SendinBlueApi.InlineResponse2008Recipients, root.SendinBlueApi.InlineResponse2008Sender, root.SendinBlueApi.InlineResponse2008Statistics);
  }
  ...
  /**
   * The InlineResponse2008Campaigns model module.
   * @module model/InlineResponse2008Campaigns
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>InlineResponse2008Campaigns</code>.
   * @alias module:model/InlineResponse2008Campaigns
   * @class
   * @param id {Number} ID of the campaign
   * @param name {String} Name of the campaign
   * @param subject {String} Subject of the campaign
   * @param type {module:model/InlineResponse2008Campaigns.TypeEnum} Type of campaign
   * @param status {module:model/InlineResponse2008Campaigns.StatusEnum} Status of the campaign
  ...
  /**
   * Constructs a <code>InlineResponse2008Campaigns</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2008Campaigns} obj Optional instance to populate.
   * @return {module:model/InlineResponse2008Campaigns} The populated <code>InlineResponse2008Campaigns</code> instance.
   */
  ...
  /**
   * Type of campaign
   * @member {module:model/InlineResponse2008Campaigns.TypeEnum} type
   */
  exports.prototype['type'] = undefined;
  /**
   * Status of the campaign
   * @member {module:model/InlineResponse2008Campaigns.StatusEnum} status
   */
