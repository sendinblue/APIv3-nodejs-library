...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendinBlueApi.InlineResponse2008StatisticsCampaignStats = factory(root.SendinBlueApi.ApiClient);
  }
  ...
  /**
   * The InlineResponse2008StatisticsCampaignStats model module.
   * @module model/InlineResponse2008StatisticsCampaignStats
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>InlineResponse2008StatisticsCampaignStats</code>.
   * @alias module:model/InlineResponse2008StatisticsCampaignStats
   * @class
  ...
  /**
   * Constructs a <code>InlineResponse2008StatisticsCampaignStats</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2008StatisticsCampaignStats} obj Optional instance to populate.
   * @return {module:model/InlineResponse2008StatisticsCampaignStats} The populated <code>InlineResponse2008StatisticsCampaignStats</code> instance.
   */
