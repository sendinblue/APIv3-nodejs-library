...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendinBlueApi.InlineResponse2009Reports = factory(root.SendinBlueApi.ApiClient);
  }
  ...
  /**
   * The InlineResponse2009Reports model module.
   * @module model/InlineResponse2009Reports
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>InlineResponse2009Reports</code>.
   * @alias module:model/InlineResponse2009Reports
   * @class
  ...
  /**
   * Constructs a <code>InlineResponse2009Reports</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2009Reports} obj Optional instance to populate.
   * @return {module:model/InlineResponse2009Reports} The populated <code>InlineResponse2009Reports</code> instance.
   */
