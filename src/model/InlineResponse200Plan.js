...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendinBlueApi.InlineResponse200Plan = factory(root.SendinBlueApi.ApiClient);
  }
  ...
  /**
   * The InlineResponse200Plan model module.
   * @module model/InlineResponse200Plan
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>InlineResponse200Plan</code>.
   * @alias module:model/InlineResponse200Plan
   * @class
   * @param type {module:model/InlineResponse200Plan.TypeEnum} Displays the plan type of the user
   * @param creditsType {module:model/InlineResponse200Plan.CreditsTypeEnum} This is the type of the credit, \"User Limit\" or \"Send Limit\" are two possible types of credit of a user. \"User Limit\" implies the total number of subscribers you can add to your account, and \"Send Limit\" implies the total number of emails you can send to the subscribers in your account.
  ...
  /**
   * Constructs a <code>InlineResponse200Plan</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse200Plan} obj Optional instance to populate.
   * @return {module:model/InlineResponse200Plan} The populated <code>InlineResponse200Plan</code> instance.
   */
   ...
   * @member {module:model/InlineResponse200Plan.TypeEnum} type
   */
   ...
   * @member {module:model/InlineResponse200Plan.CreditsTypeEnum} creditsType
   */
