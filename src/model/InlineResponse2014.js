...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse2014Contacts'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse2014Contacts'));
  } else {
    // Browser globals (root is window)
    if (!root.SendinBlueApi) {
      root.SendinBlueApi = {};
    }
    root.SendinBlueApi.InlineResponse2014 = factory(root.SendinBlueApi.ApiClient, root.SendinBlueApi.InlineResponse2014Contacts);
  }
}(this, function(ApiClient, InlineResponse2014Contacts) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('contacts')) {
        obj['contacts'] = InlineResponse2014Contacts.constructFromObject(data['contacts']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/InlineResponse2014Contacts} contacts
   */
