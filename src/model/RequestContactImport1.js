...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendinBlueApi.RequestContactImport1 = factory(root.SendinBlueApi.ApiClient, root.SendinBlueApi.ContactsimportNewList);
  }
  ...
  /**
   * The RequestContactImport1 model module.
   * @module model/RequestContactImport1
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>RequestContactImport1</code>.
   * @alias module:model/RequestContactImport1
   * @class
   */
  ...
  /**
   * Constructs a <code>RequestContactImport1</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RequestContactImport1} obj Optional instance to populate.
   * @return {module:model/RequestContactImport1} The populated <code>RequestContactImport1</code> instance.
   */
