...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendinBlueApi.ResellerChild = factory(root.SendinBlueApi.ApiClient);
  }
  ...
  /**
   * The ResellerChild model module.
   * @module model/ResellerChild
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ResellerChild</code>.
   * @alias module:model/ResellerChild
   * @class
  ...
  /**
   * Constructs a <code>ResellerChild</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResellerChild} obj Optional instance to populate.
   * @return {module:model/ResellerChild} The populated <code>ResellerChild</code> instance.
   */
