...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendinBlueApi.SendTransacSms1 = factory(root.SendinBlueApi.ApiClient);
  }
  ...
  /**
   * The SendTransacSms1 model module.
   * @module model/SendTransacSms1
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>SendTransacSms1</code>.
   * @alias module:model/SendTransacSms1
   * @class
  ...
  /**
   * Constructs a <code>SendTransacSms1</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SendTransacSms1} obj Optional instance to populate.
   * @return {module:model/SendTransacSms1} The populated <code>SendTransacSms1</code> instance.
   */
