...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendinBlueApi.Sender1 = factory(root.SendinBlueApi.ApiClient, root.SendinBlueApi.SendersIps);
  }
  ...
  /**
   * The Sender1 model module.
   * @module model/Sender1
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>Sender1</code>.
   * @alias module:model/Sender1
   * @class
   */
  ...
  /**
   * Constructs a <code>Sender1</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Sender1} obj Optional instance to populate.
   * @return {module:model/Sender1} The populated <code>Sender1</code> instance.
   */
