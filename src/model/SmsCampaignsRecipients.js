...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendinBlueApi.SmsCampaignsRecipients = factory(root.SendinBlueApi.ApiClient);
  }
  ...
  /**
   * The SmsCampaignsRecipients model module.
   * @module model/SmsCampaignsRecipients
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>SmsCampaignsRecipients</code>.
   * @alias module:model/SmsCampaignsRecipients
   * @class
  ...
  /**
   * Constructs a <code>SmsCampaignsRecipients</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SmsCampaignsRecipients} obj Optional instance to populate.
   * @return {module:model/SmsCampaignsRecipients} The populated <code>SmsCampaignsRecipients</code> instance.
   */
