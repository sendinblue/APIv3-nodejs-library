...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendinBlueApi.SmtpTemplate = factory(root.SendinBlueApi.ApiClient, root.SendinBlueApi.SmtptemplatesSender);
  }
  ...
  /**
   * The SmtpTemplate model module.
   * @module model/SmtpTemplate
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>SmtpTemplate</code>.
   * @alias module:model/SmtpTemplate
   * @class
   * @param templateName {String} Name of the template
   * @param subject {String} Subject of the template
   */
  var exports = function(templateName, subject) {
    var _this = this;
  ...
  /**
   * Constructs a <code>SmtpTemplate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SmtpTemplate} obj Optional instance to populate.
   * @return {module:model/SmtpTemplate} The populated <code>SmtpTemplate</code> instance.
   */
