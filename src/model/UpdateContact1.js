...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendinBlueApi.UpdateContact1 = factory(root.SendinBlueApi.ApiClient);
  }
  ...
  /**
   * The UpdateContact1 model module.
   * @module model/UpdateContact1
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>UpdateContact1</code>.
   * @alias module:model/UpdateContact1
   * @class
   */
  ...
  /**
   * Constructs a <code>UpdateContact1</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdateContact1} obj Optional instance to populate.
   * @return {module:model/UpdateContact1} The populated <code>UpdateContact1</code> instance.
   */
