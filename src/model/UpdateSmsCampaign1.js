...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendinBlueApi.UpdateSmsCampaign1 = factory(root.SendinBlueApi.ApiClient, root.SendinBlueApi.SmsCampaignsRecipients);
  }
  ...
  /**
   * The UpdateSmsCampaign1 model module.
   * @module model/UpdateSmsCampaign1
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>UpdateSmsCampaign1</code>.
   * @alias module:model/UpdateSmsCampaign1
   * @class
   */
  ...
  /**
   * Constructs a <code>UpdateSmsCampaign1</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdateSmsCampaign1} obj Optional instance to populate.
   * @return {module:model/UpdateSmsCampaign1} The populated <code>UpdateSmsCampaign1</code> instance.
   */
