...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.ContactsimportNewList();
  });
  ...
  describe('ContactsimportNewList', function() {
    it('should create an instance of ContactsimportNewList', function() {
      // uncomment below and update the code to test ContactsimportNewList
      //var instane = new SendinBlueApi.ContactsimportNewList();
      //expect(instance).to.be.a(SendinBlueApi.ContactsimportNewList);
    });
