...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.CreateContact1();
  });
  ...
  describe('CreateContact1', function() {
    it('should create an instance of CreateContact1', function() {
      // uncomment below and update the code to test CreateContact1
      //var instane = new SendinBlueApi.CreateContact1();
      //expect(instance).to.be.a(SendinBlueApi.CreateContact1);
    });
