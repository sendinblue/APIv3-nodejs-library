...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.CreateSmsCampaign1();
  });
  ...
  describe('CreateSmsCampaign1', function() {
    it('should create an instance of CreateSmsCampaign1', function() {
      // uncomment below and update the code to test CreateSmsCampaign1
      //var instane = new SendinBlueApi.CreateSmsCampaign1();
      //expect(instance).to.be.a(SendinBlueApi.CreateSmsCampaign1);
    });
