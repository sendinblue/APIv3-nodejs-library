...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.EmailCampaigns();
  });
  ...
  describe('EmailCampaigns', function() {
    it('should create an instance of EmailCampaigns', function() {
      // uncomment below and update the code to test EmailCampaigns
      //var instane = new SendinBlueApi.EmailCampaigns();
      //expect(instance).to.be.a(SendinBlueApi.EmailCampaigns);
    });
