...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.EmailCampaignsRecipients();
  });
  ...
  describe('EmailCampaignsRecipients', function() {
    it('should create an instance of EmailCampaignsRecipients', function() {
      // uncomment below and update the code to test EmailCampaignsRecipients
      //var instane = new SendinBlueApi.EmailCampaignsRecipients();
      //expect(instance).to.be.a(SendinBlueApi.EmailCampaignsRecipients);
    });
