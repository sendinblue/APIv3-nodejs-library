...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.EmailCampaignscampaignIdsendReportEmail();
  });
  ...
  describe('EmailCampaignscampaignIdsendReportEmail', function() {
    it('should create an instance of EmailCampaignscampaignIdsendReportEmail', function() {
      // uncomment below and update the code to test EmailCampaignscampaignIdsendReportEmail
      //var instane = new SendinBlueApi.EmailCampaignscampaignIdsendReportEmail();
      //expect(instance).to.be.a(SendinBlueApi.EmailCampaignscampaignIdsendReportEmail);
    });
