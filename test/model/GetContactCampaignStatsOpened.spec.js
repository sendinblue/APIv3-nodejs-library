...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.GetContactCampaignStatsOpened();
  });
  ...
  describe('GetContactCampaignStatsOpened', function() {
    it('should create an instance of GetContactCampaignStatsOpened', function() {
      ...
      //var instane = new SendinBlueApi.GetContactCampaignStatsOpened();
      //expect(instance).to.be.a(SendinBlueApi.GetContactCampaignStatsOpened);
    });
