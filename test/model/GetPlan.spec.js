...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.GetPlan();
  });
  ...
  describe('GetPlan', function() {
    it('should create an instance of GetPlan', function() {
      // uncomment below and update the code to test GetPlan
      //var instane = new SendinBlueApi.GetPlan();
      //expect(instance).to.be.a(SendinBlueApi.GetPlan);
    });
