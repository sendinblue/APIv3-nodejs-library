...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.GetSmsCampaign1();
  });
  ...
  describe('GetSmsCampaign1', function() {
    it('should create an instance of GetSmsCampaign1', function() {
      // uncomment below and update the code to test GetSmsCampaign1
      //var instane = new SendinBlueApi.GetSmsCampaign1();
      //expect(instance).to.be.a(SendinBlueApi.GetSmsCampaign1);
    });
