...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.GetTransacSmsReport();
  });
  ...
  describe('GetTransacSmsReport', function() {
    it('should create an instance of GetTransacSmsReport', function() {
      ...
      //var instane = new SendinBlueApi.GetTransacSmsReport();
      //expect(instance).to.be.a(SendinBlueApi.GetTransacSmsReport);
    });
