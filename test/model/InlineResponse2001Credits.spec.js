...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.InlineResponse2001Credits();
  });
  ...
  describe('InlineResponse2001Credits', function() {
    it('should create an instance of InlineResponse2001Credits', function() {
      // uncomment below and update the code to test InlineResponse2001Credits
      //var instane = new SendinBlueApi.InlineResponse2001Credits();
      //expect(instance).to.be.a(SendinBlueApi.InlineResponse2001Credits);
    });
