...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.InlineResponse20021Statistics();
  });
  ...
  describe('InlineResponse20021Statistics', function() {
    it('should create an instance of InlineResponse20021Statistics', function() {
      // uncomment below and update the code to test InlineResponse20021Statistics
      //var instane = new SendinBlueApi.InlineResponse20021Statistics();
      //expect(instance).to.be.a(SendinBlueApi.InlineResponse20021Statistics);
    });
