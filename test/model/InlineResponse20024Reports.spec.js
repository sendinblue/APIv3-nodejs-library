...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.InlineResponse20024Reports();
  });
  ...
  describe('InlineResponse20024Reports', function() {
    it('should create an instance of InlineResponse20024Reports', function() {
      // uncomment below and update the code to test InlineResponse20024Reports
      //var instane = new SendinBlueApi.InlineResponse20024Reports();
      //expect(instance).to.be.a(SendinBlueApi.InlineResponse20024Reports);
    });
