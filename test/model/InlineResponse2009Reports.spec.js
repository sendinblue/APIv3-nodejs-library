...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.InlineResponse2009Reports();
  });
  ...
  describe('InlineResponse2009Reports', function() {
    it('should create an instance of InlineResponse2009Reports', function() {
      // uncomment below and update the code to test InlineResponse2009Reports
      //var instane = new SendinBlueApi.InlineResponse2009Reports();
      //expect(instance).to.be.a(SendinBlueApi.InlineResponse2009Reports);
    });
