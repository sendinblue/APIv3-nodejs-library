...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.InlineResponse200Plan();
  });
  ...
  describe('InlineResponse200Plan', function() {
    it('should create an instance of InlineResponse200Plan', function() {
      // uncomment below and update the code to test InlineResponse200Plan
      //var instane = new SendinBlueApi.InlineResponse200Plan();
      //expect(instance).to.be.a(SendinBlueApi.InlineResponse200Plan);
    });
