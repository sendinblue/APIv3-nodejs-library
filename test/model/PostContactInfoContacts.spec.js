...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.PostContactInfoContacts();
  });
  ...
  describe('PostContactInfoContacts', function() {
    it('should create an instance of PostContactInfoContacts', function() {
      ...
      //var instane = new SendinBlueApi.PostContactInfoContacts();
      //expect(instance).to.be.a(SendinBlueApi.PostContactInfoContacts);
    });
