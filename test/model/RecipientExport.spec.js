...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.RecipientExport();
  });
  ...
  describe('RecipientExport', function() {
    it('should create an instance of RecipientExport', function() {
      // uncomment below and update the code to test RecipientExport
      //var instane = new SendinBlueApi.RecipientExport();
      //expect(instance).to.be.a(SendinBlueApi.RecipientExport);
    });
