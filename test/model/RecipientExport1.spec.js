...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.RecipientExport1();
  });
  ...
  describe('RecipientExport1', function() {
    it('should create an instance of RecipientExport1', function() {
      // uncomment below and update the code to test RecipientExport1
      //var instane = new SendinBlueApi.RecipientExport1();
      //expect(instance).to.be.a(SendinBlueApi.RecipientExport1);
    });
