...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.RemainingCreditModelChild();
  });
  ...
  describe('RemainingCreditModelChild', function() {
    it('should create an instance of RemainingCreditModelChild', function() {
      ...
      //var instane = new SendinBlueApi.RemainingCreditModelChild();
      //expect(instance).to.be.a(SendinBlueApi.RemainingCreditModelChild);
    });
