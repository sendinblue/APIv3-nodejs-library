...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.RequestContactExport1();
  });
  ...
  describe('RequestContactExport1', function() {
    it('should create an instance of RequestContactExport1', function() {
      // uncomment below and update the code to test RequestContactExport1
      //var instane = new SendinBlueApi.RequestContactExport1();
      //expect(instance).to.be.a(SendinBlueApi.RequestContactExport1);
    });
