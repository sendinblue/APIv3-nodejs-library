...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.RequestContactImport1();
  });
  ...
  describe('RequestContactImport1', function() {
    it('should create an instance of RequestContactImport1', function() {
      // uncomment below and update the code to test RequestContactImport1
      //var instane = new SendinBlueApi.RequestContactImport1();
      //expect(instance).to.be.a(SendinBlueApi.RequestContactImport1);
    });
