...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.SendSmtpEmail1();
  });
  ...
  describe('SendSmtpEmail1', function() {
    it('should create an instance of SendSmtpEmail1', function() {
      // uncomment below and update the code to test SendSmtpEmail1
      //var instane = new SendinBlueApi.SendSmtpEmail1();
      //expect(instance).to.be.a(SendinBlueApi.SendSmtpEmail1);
    });
