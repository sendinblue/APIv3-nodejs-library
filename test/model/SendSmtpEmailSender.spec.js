...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.SendSmtpEmailSender();
  });
  ...
  describe('SendSmtpEmailSender', function() {
    it('should create an instance of SendSmtpEmailSender', function() {
      ...
      //var instane = new SendinBlueApi.SendSmtpEmailSender();
      //expect(instance).to.be.a(SendinBlueApi.SendSmtpEmailSender);
    });
