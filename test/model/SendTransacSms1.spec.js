...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.SendTransacSms1();
  });
  ...
  describe('SendTransacSms1', function() {
    it('should create an instance of SendTransacSms1', function() {
      // uncomment below and update the code to test SendTransacSms1
      //var instane = new SendinBlueApi.SendTransacSms1();
      //expect(instance).to.be.a(SendinBlueApi.SendTransacSms1);
    });
