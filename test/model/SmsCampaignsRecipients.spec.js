...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.SmsCampaignsRecipients();
  });
  ...
  describe('SmsCampaignsRecipients', function() {
    it('should create an instance of SmsCampaignsRecipients', function() {
      // uncomment below and update the code to test SmsCampaignsRecipients
      //var instane = new SendinBlueApi.SmsCampaignsRecipients();
      //expect(instance).to.be.a(SendinBlueApi.SmsCampaignsRecipients);
    });
