...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.SmtpTemplate();
  });
  ...
  describe('SmtpTemplate', function() {
    it('should create an instance of SmtpTemplate', function() {
      // uncomment below and update the code to test SmtpTemplate
      //var instane = new SendinBlueApi.SmtpTemplate();
      //expect(instance).to.be.a(SendinBlueApi.SmtpTemplate);
    });
