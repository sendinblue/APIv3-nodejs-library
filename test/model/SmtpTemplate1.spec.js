...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.SmtpTemplate1();
  });
  ...
  describe('SmtpTemplate1', function() {
    it('should create an instance of SmtpTemplate1', function() {
      // uncomment below and update the code to test SmtpTemplate1
      //var instane = new SendinBlueApi.SmtpTemplate1();
      //expect(instance).to.be.a(SendinBlueApi.SmtpTemplate1);
    });
