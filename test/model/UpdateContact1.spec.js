...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.UpdateContact1();
  });
  ...
  describe('UpdateContact1', function() {
    it('should create an instance of UpdateContact1', function() {
      // uncomment below and update the code to test UpdateContact1
      //var instane = new SendinBlueApi.UpdateContact1();
      //expect(instance).to.be.a(SendinBlueApi.UpdateContact1);
    });
