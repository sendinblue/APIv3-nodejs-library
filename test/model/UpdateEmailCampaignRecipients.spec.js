...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.UpdateEmailCampaignRecipients();
  });
  ...
  describe('UpdateEmailCampaignRecipients', function() {
    it('should create an instance of UpdateEmailCampaignRecipients', function() {
      ...
      //var instane = new SendinBlueApi.UpdateEmailCampaignRecipients();
      //expect(instance).to.be.a(SendinBlueApi.UpdateEmailCampaignRecipients);
    });
